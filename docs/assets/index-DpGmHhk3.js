import{f as h}from"./chunk-KZPPZA2C-rvBpA5M9.js";import{Q as m,aj as t,ar as y,b9 as g,be as b,bl as k,aK as v}from"./index-BCxd8sac.js";import{p as N}from"./index-BMxOGu3m.js";import{e as T}from"./explain-akgjaevf.js";import{m as p}from"./markdown-CwRoXAEV.js";import{a as d}from"./index-FekbOvEq.js";import"./canvasRender-CRddz0Wb-DhzwJvmV.js";import"./iconBase-CuUokogw.js";import"./index-ucKcYh2g.js";import"./marked.esm-BaswSlok.js";function S(){const u=[{id:Date.now(),time:Date.now()}],n=m(u);T(function(){p`
# 数据驱动的退出动画
...
退出时,采用对旧元素clone的方式,使元素内的数据保持不变
          `,N(x,(e,s)=>{const o=f(e,s);return e.promise()&&d(o,{x:["100%",0]}).then(e.resolve),{node:o,applyAnimate(a){e.promise()&&d(a,{x:[0,"100%"]}).then(e.resolve)}}})}}),t.button({onClick(){const e={id:Date.now(),time:Date.now()},s=n.get().slice(),o=h.number.int({min:0,max:s.length});s.splice(o,0,e),n.set(s)},className:"daisy-btn daisy-btn-primary",childrenType:"text",children:"随机增加"})}})}export{S as default};
