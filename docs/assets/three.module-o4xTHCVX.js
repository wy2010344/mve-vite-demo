import{d7 as Lr,ba as At,cj as Dr,x as Ke,a9 as tr,aP as Ht,cZ as We,bD as wr,c_ as lt,df as on,d2 as Vt,y as tt,aD as Yt,ag as hn,cQ as It,W as Mt,B as _t,a8 as $t,dd as Ir,de as Nr,aF as _n,dc as yr,d0 as Or,a3 as Fr,cY as ft,br as sn,j as Br,d3 as Sn,bF as Tt,T as dn,S as Wn,cR as Zt,cT as Qt,U as nr,bA as Gr,b9 as Ft,aw as un,cg as Hr,cz as Vr,a as Xt,bi as kr,z as Wr,bj as zr,D as Xr,bk as Yr,bl as qr,bm as Kr,bn as $r,X as Zr,Y as Qr,cx as Jr,cw as jr,cy as ea,bh as ta,d4 as na,a_ as ia,v as ra,cf as aa,aE as Mn,aB as Bt,b3 as tn,b4 as oa,b2 as Kt,bc as sa,ab as ca,ad as la,_ as fa,av as ir,at as da,f as ua,b6 as pa,bs as ha,aO as Fe,aT as _a,bE as ma,aU as va,cm as Nt,s as rr,r as cn,aR as xt,bp as ar,b8 as wt,cX as St,cW as pn,cU as or,cV as sr,cE as cr,bt as lr,cS as ga,t as Ea,cn as Sa,am as fr,a6 as Dt,e as Ma,c0 as Ta,cc as xa,cd as dr,c8 as Aa,c9 as ur,bG as pr,c7 as Tn,bZ as xn,b_ as An,b$ as Rn,ck as Ye,c6 as Jn,c5 as jn,bY as ei,bX as ti,c3 as ni,c4 as ii,bW as ri,bN as ai,bO as oi,bP as si,bQ as ci,bR as li,bS as fi,bT as di,bU as ui,bI as pi,bJ as hi,bK as _i,bH as mi,bL as vi,bM as gi,bV as Cn,c1 as Ei,c2 as Si,bC as Ra,ci as Mi,bB as Ti,ch as xi,bd as In,ac as Nn,ae as yn,$ as On,au as Fn,g as Bn,b7 as Gn,L as Ca,J as Ai,K as ba,bb as ln,M as Pa,b0 as Ri,cA as Ci,c as bi,a0 as Hn,a1 as Vn,d1 as Ua,P as hr,cP as La,I as mn,cC as Da,bg as wa,da as _r,q as mr,d6 as Pi,a2 as vr,d9 as Ui,aH as gr,F as Jt,G as kt,bo as Ia,aS as Na,cO as ya,cN as Oa,d5 as Fa,aa as Li,db as ct,as as Ba,bq as Ga,N as Ha,b5 as Va,d as ka,A as Wa,u as za,ce as Xa,aG as Ya,H as qa,O as Ka,d8 as $a,b as Za,a$ as Qa,b1 as Ja,aZ as ja,aQ as eo}from"./three.core-DLxfQLdm.js";function Er(){let e=null,n=!1,t=null,i=null;function c(o,h){t(o,h),i=e.requestAnimationFrame(c)}return{start:function(){n!==!0&&t!==null&&(i=e.requestAnimationFrame(c),n=!0)},stop:function(){e.cancelAnimationFrame(i),n=!1},setAnimationLoop:function(o){t=o},setContext:function(o){e=o}}}function to(e){const n=new WeakMap;function t(u,C){const M=u.array,D=u.usage,T=M.byteLength,g=e.createBuffer();e.bindBuffer(C,g),e.bufferData(C,M,D),u.onUploadCallback();let A;if(M instanceof Float32Array)A=e.FLOAT;else if(M instanceof Uint16Array)u.isFloat16BufferAttribute?A=e.HALF_FLOAT:A=e.UNSIGNED_SHORT;else if(M instanceof Int16Array)A=e.SHORT;else if(M instanceof Uint32Array)A=e.UNSIGNED_INT;else if(M instanceof Int32Array)A=e.INT;else if(M instanceof Int8Array)A=e.BYTE;else if(M instanceof Uint8Array)A=e.UNSIGNED_BYTE;else if(M instanceof Uint8ClampedArray)A=e.UNSIGNED_BYTE;else throw new Error("THREE.WebGLAttributes: Unsupported buffer data format: "+M);return{buffer:g,type:A,bytesPerElement:M.BYTES_PER_ELEMENT,version:u.version,size:T}}function i(u,C,M){const D=C.array,T=C.updateRanges;if(e.bindBuffer(M,u),T.length===0)e.bufferSubData(M,0,D);else{T.sort((A,O)=>A.start-O.start);let g=0;for(let A=1;A<T.length;A++){const O=T[g],U=T[A];U.start<=O.start+O.count+1?O.count=Math.max(O.count,U.start+U.count-O.start):(++g,T[g]=U)}T.length=g+1;for(let A=0,O=T.length;A<O;A++){const U=T[A];e.bufferSubData(M,U.start*D.BYTES_PER_ELEMENT,D,U.start,U.count)}C.clearUpdateRanges()}C.onUploadCallback()}function c(u){return u.isInterleavedBufferAttribute&&(u=u.data),n.get(u)}function o(u){u.isInterleavedBufferAttribute&&(u=u.data);const C=n.get(u);C&&(e.deleteBuffer(C.buffer),n.delete(u))}function h(u,C){if(u.isInterleavedBufferAttribute&&(u=u.data),u.isGLBufferAttribute){const D=n.get(u);(!D||D.version<u.version)&&n.set(u,{buffer:u.buffer,type:u.type,bytesPerElement:u.elementSize,version:u.version});return}const M=n.get(u);if(M===void 0)n.set(u,t(u,C));else if(M.version<u.version){if(M.size!==u.array.byteLength)throw new Error("THREE.WebGLAttributes: The size of the buffer attribute's array buffer does not match the original size. Resizing buffer attributes is not supported.");i(M.buffer,u,C),M.version=u.version}}return{get:c,remove:o,update:h}}var no=`#ifdef USE_ALPHAHASH
...
`)}function Kl(e,n){let t;switch(n){case Ya:t="Linear";break;case Xa:t="Reinhard";break;case za:t="Cineon";break;case Wa:t="ACESFilmic";break;case ka:t="AgX";break;case Va:t="Neutral";break;case Ha:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",n),t="Linear"}return"vec3 "+e+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const an=new We;function $l(){tt.getLuminanceCoefficients(an);const e=an.x.toFixed(4),n=an.y.toFixed(4),t=an.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${e}, ${n}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+r);const x=L+l+h,m=L+r+u,H=Xi(c,c.VERTEX_SHADER,x),P=Xi(c,c.FRAGMENT_SHADER,m);c.attachShader(U,H),c.attachShader(U,P),t.index0AttributeName!==void 0?c.bindAttribLocation(U,0,t.index0AttributeName):t.morphTargets===!0&&c.bindAttribLocation(U,0,"position"),c.linkProgram(U);function N(R){if(e.debug.checkShaderErrors){const q=c.getProgramInfoLog(U).trim(),V=c.getShaderInfoLog(H).trim(),Y=c.getShaderInfoLog(P).trim();let Q=!0,z=!0;if(c.getProgramParameter(U,c.LINK_STATUS)===!1)if(Q=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(c,U,H,P);else{const j=qi(c,H,"vertex"),F=qi(c,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+c.getError()+" - VALIDATE_STATUS "+c.getProgramParameter(U,c.VALIDATE_STATUS)+`
