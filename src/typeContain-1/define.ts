...
export class Any<T> {
  private constructor(readonly flag: T) {}
...
export class VarType {
  constructor(public readonly belong: AllMayType) {}
}
 ...
 */
export class Struct {
  constructor(readonly fields: ReadMap<string, AllMayType>) {}
}

export type AllMayType =
  | VarType
  | Union<AllMayType>
  | Fun<AllMayType>
  | Struct
