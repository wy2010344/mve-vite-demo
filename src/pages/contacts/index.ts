...
export default function () {
  renderMobileView(function ({ height }) {
    type Person = {
      name: string;
      phone: string;
    };
    ...
    fdom.div({
      ...
      children() {
        fdom.table({
          ...
          children() {
            renderArrayKey<PersonGroup, string>(
              () => personsGroups,
              v => v.firstKey,
              function (getRow, getIndex, key) {
                fdom.thead({
                  children() {
                    fdom.tr({
                      children() {
                ...
                fdom.tbody({
                  children() {
                    renderArrayKey<Person, string>(
                      () => getRow().list,
                      v => v.name,
                      function (getPerson, getIndex, key) {
                        fdom.tr({
                          children() {
