  ...
  for (let i = 0; i < table.length; i += 5) {
    const element = fdom.div({
      ...
      children() {
        fdom.div({
          className:
            'number absolute text-xs text-[rgba(127,255,255,0.75)] right-5 top-5',
          childrenType: 'text',
          children: i / 5 + 1,
        });
        ...
        fdom.div({
          className:
            'symbol absolute text-6xl font-[bold] text-[rgba(255,255,255,0.75)] top-10 inset-x-0 t',
          childrenType: 'text',
        ...
        fdom.div({
          className:
            'details absolute text-xs text-[rgba(127,255,255,0.75)] bottom-[15px] inset-x-0',
          children() {
...
function menuItem(children: string, onClick: EmptyFun) {
  fdom.button({
