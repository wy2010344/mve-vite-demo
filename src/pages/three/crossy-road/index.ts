...
export default function () {
  fdom.div({
    ...
    children() {
      ...
      fdom.div({
        className:
          'absolute min-w-full min-h-full top-0 flex items-center justify-center',
        s_visibility() {
      ...
      fdom.div({
        className:
          'absolute min-w-full bottom-5  flex items-end justify-center',
        children() {
          fdom.div({
            ...
            children() {
              ...
              fdom.button({
                className:
                  'w-full h-[40px] bg-white border-1 border-gray-100 shadow-2xl [grid-column:1/-1]',
                childrenType: 'text',
                children: '▲',
                onClick() {
                  queueMove('forward');
              ...
              fdom.button({
                className:
                  'w-full h-[40px] bg-white border-1 border-gray-100 shadow-2xl',
                childrenType: 'text',
                children: '◀',
                onClick() {
                  queueMove('left');
