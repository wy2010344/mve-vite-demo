  ...
  renderMobileView(function () {
    ...
    fdom.div({
      ...
      children() {
        ...
        function renderList(
          renderView: (key: number, et: EachTime<Model>) => void
        ) {
                ...
                onMove(e, dir) {
                  ...
                  return scrollX.getMoveEvent(e, 'x', {
                    callback(direction, velocity) {
                      ...
                      selectIndex.set(
                        circleFormat(selectIndex.get() + direction, max)
                      );
                    },
                  });
                },
                            ...
                            children() {
                              fdom.tr({
                                children() {
                                  ...
                                  fdom.td({
                                    className:
                                      'pt-4 pb-4 border-b-1 border-b-base-300',
                                    children() {
                                      fdom.h1({
